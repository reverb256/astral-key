 ...
 * Precedence: ?lang= > cookie > Accept-Language > 'en'
 */
 ...
 * Falls back to the key name if not found, then to 'en'.
 */
 ...
 * Looks up both locales for the given key, falls back to the key itself.
 */
